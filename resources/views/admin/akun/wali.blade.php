    ...
    <div class="px-4 pt-24 bg-slate-200 dark:bg-gray-800 h-screen   ">
                                ...
                                @foreach ($data as $no => $item)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            ...
                                            <button onclick="modaledit{{ $no }}.showModal()"
            ...
            <div class="modal-box bg-white">
                ...
                <form action="/akun-wali/create" method="POST">
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <input type="text" name="nama" class="grow rounded-lg w-full text-black"
                            placeholder="Nafis" />
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <input type="email" name="email" class="grow rounded-lg w-full text-black"
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <input type="text" name="alamat" class="grow rounded-lg w-full text-black"
                            placeholder="Kepohbaru" />
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <input type="number" name="telepon" class="grow rounded-lg w-full text-black"
                            placeholder="nafis@gmail.com" />
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <input type="password" name="password" class="grow rounded-lg w-full text-black"
                            placeholder="*****" />
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <select name="role" id="" class="grow rounded-lg w-full text-black">
                ...
                <div class="modal-box bg-white">
                    ...
                    <form action="/akun-wali/edit/{{ $edit->user_id }}" method="POST">
                        ...
                        <label class="items-center gap-2 ">
                            ...
                            <input type="email" name="email" class="grow rounded-lg w-full text-black"
                                placeholder="nafis@gmail.com" value="{{ $edit->email }}" />
                        ...
                        <label class="items-center gap-2 ">
                            ...
                            <input type="text" name="alamat" class="grow rounded-lg w-full text-black"
                                placeholder="Sakur" value="{{ $edit->alamat }}" />
                        ...
                        <label class="items-center gap-2 ">
                            ...
                            <input type="number" name="telepon" class="grow rounded-lg w-full text-black"
                                placeholder="nafis@gmail.com" value="{{ $edit->telepon }}" />
        ...
        @foreach ($data as $no => $item)
            <dialog id="hapus_{{ $no }}" class="modal modal-bottom sm:modal-middle ">
                <form action="/akun-wali/delete/{{ $item->user_id }}" method="POST"
