...
@section('container')
            ...
            <div class="modal-box bg-white">
                ...
                <form action="/santri/create" method="POST">
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <input type="date" name="tgl_lahir" class="grow rounded-lg w-full text-black" placeholder="" />
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <select name="jenis_kelamin" id="" class="grow rounded-lg w-full text-black">
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <select name="user" id="" class="w-full text-black rounded-lg">
                            @foreach ($wali as $cek)
                                <option class="capitalize" value="{{ $cek->user_id }}">{{ $cek->nama }}
                                    {{-- {{ $cek->role }} --}}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <label class="items-center gap-2 ">
                        ...
                        <select name="kelas" id="" class="grow rounded-lg w-full text-black">
                        ...
                        <select name="kelas" class="grow rounded-lg w-full text-black">
                            @foreach ($kelas as $item)
                                <option value="{{ $item->kelas_id }}"
                                    {{ $item->kelas_id === $oke->kelas_id ? 'selected' : '' }}>
    ...
    @endforeach
        ...
        <dialog id="hapus_{{ $delete }}" class="modal modal-bottom sm:modal-middle ">
            <form action="/santri/delete/{{ $hapus->santri_id }}" method="POST"
