    ...
    <div class="bg-gray-100 flex h-screen items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8">
            <div class="bg-white shadow-md rounded-md p-6">
                ...
                <form class="space-y-4 md:space-y-2" action="/register/akun" method="POST">
                    @csrf

                    <div>
                        <label for="new-password" class="block text-sm font-medium text-gray-700">Nama</label>
                        <div class="mt-1">
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">telepon</label>
                        <div class="mt-1">
                            <input name="telepon" type="number" autocomplete="email-address" required
                                class="px-2 py-3 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm bg-white text-black" />
                        </div>
                    </div>
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">Alamat</label>
                        <div class="mt-1">
                            <input type="text" placeholder='Kepohbaru' name="alamat"
