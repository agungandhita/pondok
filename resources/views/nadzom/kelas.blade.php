    ...
    <div class="px-4 pt-24 bg-slate-200 dark:bg-gray-800 h-screen   ">
        ...
        <dialog id="modaledit_{{ $update }}" class="modal">
            <div class="modal-box bg-white">
                ...
                <form action="/input/nilai/{{ $oke->santri_id }}" method="POST">
                    @csrf
                    <label class="items-center gap-2 ">
                        <h1 class="font-semibold text-black mb-2 mt-2">
                            Masukan nilai
                        </h1>
                        <input type="text" name="nilai_nadzom" class="grow rounded-lg w-full text-black" placeholder="dalam bentuk angka atau catatan" />
